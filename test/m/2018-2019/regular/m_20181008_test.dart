...
void main() {
  group('2018/10/08 1試合目', () {
    ...
    testWidgets('東2局 3本場', (WidgetTester tester) async {
      ...
      expect(find.text('4300点 all'), findsOneWidget);
    ...
    testWidgets('東2局 4本場', (WidgetTester tester) async {
      ...
      expect(find.text('4400点'), findsOneWidget);
    ...
    testWidgets('東4局 1本場', (WidgetTester tester) async {
      ...
      expect(find.text('嶺上開花'), findsOneWidget);
