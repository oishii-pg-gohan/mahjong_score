...
void main() {
  group('七対子あり', () {
    ...
    test('2翻, 符25', () {
      ...
      FinishId finishId = getFinishId(han, fu, hasPinfu, hasChitoitsu);
      expect(finishId, FinishId.han2Chitoitsu);
    ...
    test('3翻, 符25', () {
      ...
      FinishId finishId = getFinishId(han, fu, hasPinfu, hasChitoitsu);
      expect(finishId, FinishId.han3Chitoitsu);
    ...
    test('4翻, 符25', () {
      ...
      FinishId finishId = getFinishId(han, fu, hasPinfu, hasChitoitsu);
      expect(finishId, FinishId.han4Chitoitsu);
